...
ConstantValue* compileUnsignedConstant(void) {
  ...
  case TK_CHAR:
    ...
    constValue = makeCharConstant((char)currentToken->value);
...
void compileParam(void) {
  ...
  case TK_IDENT:
    ...
    obj = createParameterObject(currentToken->string, PARAM_VALUE, owner);
  ...
  case KW_VAR:
    ...
    obj = createParameterObject(currentToken->string, PARAM_REFERENCE, owner);
